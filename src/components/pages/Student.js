                ...
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    <div className="card" style={{ width: "12rem" }}>
                        <div className="card-body">
                            <h5 className="card-title">Degree-2020</h5>
                            <h6 className="card-subtitle mb-2 text-muted">MPCs & MPC</h6>
                    ...
                    <div className="card" style={{ width: "12rem" }}>
                        <div className="card-body">
                            <h5 className="card-title">Degree-2021</h5>
                            <h6 className="card-subtitle mb-2 text-muted">MPCs & MPC</h6>
                    ...
                    <div className="card" style={{ width: "12rem" }}>
                        <div className="card-body">
                            <h5 className="card-title">Degree-2022</h5>
                            <h6 className="card-subtitle mb-2 text-muted">MPCs & MPC</h6>
                    ...
                    <div className="card" style={{ width: "12rem" }}>
                        <div className="card-body">
                            <h5 className="card-title">Degree-2023</h5>
                            <h6 className="card-subtitle mb-2 text-muted">MPCs & MPC</h6>
